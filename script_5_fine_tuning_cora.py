...
from code.pretrain_MethodGraphBertNodeClassification import Pretrain_MethodGraphBertNodeClassification
...
if 1:
    ...
    method_obj = Pretrain_MethodGraphBertNodeClassification(bert_config)
